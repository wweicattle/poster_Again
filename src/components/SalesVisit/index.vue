<template>
  <div id="salevisit-contain">
    <div class="birth-back">
      <div class="member-back">
        <span class="member-birth-title">会员售后回访</span
        ><span class="member-birth-content"
          >为会员售后送上一声祝福，体现品牌高度</span
        >
      ...
      getSaleFeedbacklist(obj)
        .then((da) => {
          if (da.data.errcode == 0) {
            ...
            this.$notify({
              type: "warning",
              message: da.data.errmsg || "获取售后回访列表失败！请稍后重试",
            });
          }
        })
        .catch((da) => {
